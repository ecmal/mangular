system.register("mangular/module", ["runtime/reflect/class", "runtime/module", "runtime/reflect/declaration"], function(system,module) {
    var class_1, module_1, declaration_1;
    var modules;
    var MangularModules = module.define("interface","MangularModules");
    var MangularModule = (function (__super) {
        ...
        MangularModule.getPropertyValue = function (field) {
    ...
    module.define('class', MangularModule);
    module.export("MangularModule", MangularModule);
    return {
        setters:[
            function (class_1_1) {
                class_1 = class_1_1;
        ...
        execute: function() {
            modules = {};
            MangularModule = module.init(MangularModule);
        }
    }
});
